...
final class DashboardController extends AbstractDashboardController
{
    ...
    public function index(): Response
    {
        ...
        $labels = [
            ...
            'FALSE_REPORTS' => KpiConstants::FALSE_REPORTS,
            'AVG_SEVERITY' => KpiConstants::AVG_SEVERITY,
            'HELL_ARENA' => KpiConstants::HELL_ARENA,
            'AUBAINE' => KpiConstants::AUBAINE,
            'GRAND_RECIDIVIST' => KpiConstants::GRAND_RECIDIVIST,
            'GOLDEN_BALANCE' => KpiConstants::GOLDEN_BALANCE,
            'ANGEL_ARENA' => KpiConstants::ANGEL_ARENA,
            'SNIPER' => KpiConstants::SNIPER,
            'CALOMNIATEUR' => KpiConstants::CALOMNIATEUR,
            'PARIA' => KpiConstants::PARIA,
            'RIVALRY' => KpiConstants::RIVALRY,
            'CASSE_SIECLE' => KpiConstants::CASSE_SIECLE,
            'IRON_REFEREE' => KpiConstants::IRON_REFEREE,
            'ANGEL_REFEREE' => KpiConstants::ANGEL_REFEREE,
        ];
